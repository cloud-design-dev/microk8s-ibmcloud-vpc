...
| <a name="input_controller_node_count"></a> [controller\_node\_count](#input\_controller\_node\_count) | Number of controller nodes to create. | `number` | `1` | no |
...
| <a name="input_worker_node_count"></a> [worker\_node\_count](#input\_worker\_node\_count) | Number of worker nodes to create. | `number` | `3` | no |
